    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto relative">
        {mode === 'edit' ? (
          ...
          <div className="p-4 prose max-w-none text-on-surface prose-headings:text-on-surface prose-p:text-on-surface-variant prose-li:text-on-surface-variant prose-td:text-on-surface-variant prose-th:text-on-surface prose-strong:text-on-surface prose-a:text-primary">
            <ReactMarkdown
